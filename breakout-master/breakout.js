...
//const spaceFacts = [
    ...
    //"The nearest star to Earth, other than the Sun, is Proxima Centauri, which is about 4.2 light-years away.",
    ...
    //"Jupiter is the largest planet in our solar system and has 79 known moons.",
    //"Saturn is known for its beautiful rings, which are made up of ice and rock particles.",
  //  "Venus is the hottest planet in our solar system, with an average surface temperature of about 864 degrees Fahrenheit."
//];
